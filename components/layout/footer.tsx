...
export function Footer() {
  return (
    <footer className="relative border-t border-[rgb(255_255_255/0.06)]">
      {/* Background Effects */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className={cn(
            ...
            'opacity-[0.03] blur-[100px]'
          )}
        />
        <div
          className={cn(
            'absolute -bottom-40 -right-40 w-80 h-80',
      ...
      <div className="relative container mx-auto px-4 lg:px-8 py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-[rgb(var(--color-text-muted))] leading-relaxed max-w-sm">
              Watch better. Together. Experience cinema like never before with
              personalized recommendations and synchronized viewing with friends.
            </p>
          ...
          {Object.entries(FOOTER_LINKS).map(([category, links]) => (
            <div key={category}>
              <h4 className="text-sm font-semibold text-[rgb(var(--color-text-primary))] mb-4">
                {category}
              </h4>
                ...
                {links.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className={cn(
                        'text-sm text-[rgb(var(--color-text-muted))]',
        ...
        <div
          className={cn(
            'pt-8 border-t border-[rgb(255_255_255/0.06)]',
            'flex flex-col sm:flex-row items-center justify-between gap-4'
          )}
        >
          {/* Copyright */}
          <p className="text-sm text-[rgb(var(--color-text-muted))]">
            &copy; {new Date().getFullYear()} WeFrame. All rights reserved.
          </p>
